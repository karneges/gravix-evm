...
import type { Gravix, GravixInterface } from '../Gravix.js'
...
type GravixConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: GravixConstructorParams): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1
...
export class Gravix__factory extends ContractFactory {
    ...
    override getDeployTransaction(
        ...
        return super.getDeployTransaction(_usdt, _stgUsdt, _priceNode, overrides || {})
    }
    override deploy(
        _usdt: AddressLike,
        _stgUsdt: AddressLike,
        ...
        return super.deploy(_usdt, _stgUsdt, _priceNode, overrides || {}) as Promise<
            Gravix & {
